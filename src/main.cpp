...
int main() {
    ...
    constexpr auto SENHA = "pao";
    const std::string MESSAGE = "Mensagem secreta";

    // Banco
    if (init_sql() != 0) return 1;
    ...
    if (inserir_dados(to_base64(salt), to_base64(nonce), to_base64(cipher)) != 0) return 1;
